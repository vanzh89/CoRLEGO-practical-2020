...
sim.addElement(SingleNodeDynamics('nodeRed', 40, 8, 4, -10, 0.2, samplingRange, samplingResolution), 'targetImage','inputForRed');
sim.addElement(SingleNodeDynamics('nodeGreen', 40, 8, 4, -10, 0.2, samplingRange, samplingResolution), 'targetImage','inputForGreen');
sim.addElement(SingleNodeDynamics('nodeBlue', 40, 8, 4, -10, 0.2, samplingRange, samplingResolution), 'targetImage','inputForBlue');
...
%% setting up the GUI
    ...
    gui.addVisualization(MultiPlot({'nodeRed', 'stimulusHistoryRed', 'historyRedNodeActivation','historyRedNodeOutput'}, {'activation', 'output','output','output'}, ...
        [1, 1, 1, 1], 'horizontal', ...
        {'FontSize',18,'XLim', [-historyDuration, 10], 'YLim', [-30, 30], 'Box', 'on', 'XGrid', 'on', 'YGrid', 'on'}, ...
